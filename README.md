[README.md](https://github.com/user-attachments/files/29042091/README.md)
...
|---|---|
| `auth_logs.csv` | VPN authentication logs, including successful and failed login attempts |
| `firewall_logs.csv` | Firewall traffic logs, including allowed and blocked connections |
| `web_access_logs.csv` | Web access logs, including normal and suspicious web requests |
...
[detection_use_cases.md](detection_use_cases.md)
